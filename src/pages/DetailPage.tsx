...
import { useGetRestaurant } from "@/api/restaurantsListApi";
...
import { UserFormData } from "@/forms/user-profileForms/userProfileForm";
...
const DetailPage = () => {
    ...
    const [cartItems,setCartItems] = useState<CartItem[]>(() =>{
        ...
        //If there are cart items stored in the session storage, parse them and return them. Otherwise, return an empty array.
    });
    ...
    const addToCart = (menuItem:MenuItemType) =>{
        ...
        setCartItems((prevCartItems) => {
            ...
            sessionStorage.setItem(`cartItems-${restaurantId}`,JSON.stringify(updatedCartItems));//Save the cart items to the session storage
    ...
    const onCheckout = async (userFormData:UserFormData) =>{
        ...
        window.location.href = data.url;//Redirect the user to the checkout page
    }
